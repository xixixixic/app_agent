<template>
    <div class="detail">
        <div class="info">
            <p class="desTitle" ref='nameTitle'>工作内容</p>
            <p class="placeholders">
                <input type="text" placeholder="请填写工作内容" class="placeholdersInput" v-model="values" @blur='verValue'/>
            </p>
        </div>
...
export default {
    ...
    methods: {
        setDefalut () {
            this.values = this.Info.defaultPositionName
        },
        verValue () {
