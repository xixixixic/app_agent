<template>
    <div class="detail">
        <div class="info">
            <p class="desTitle" ref='nameTitle'>单位地址</p>
            <p class="placeholders">
                <input type="text" placeholder="请填写单位地址" class="placeholdersInput" v-model="values" @blur='verValue'/>
            </p>
        </div>
...
export default {
    ...
    methods: {
        setDefalut () {
            this.values = this.Info.defaultPostalAddress
        },
        verValue () {
