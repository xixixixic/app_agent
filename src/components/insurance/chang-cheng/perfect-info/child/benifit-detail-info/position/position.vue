...
<div class="warp">
    ...
    <section class="showChose" v-show="showChose">
      <section class="address">
        ...
        <section class="title">
          <div class="area" @click="firstSelected()" :class="First.length > 14?'firstActive':''">职业大类：{{First?First:'请选择'}}</div>
      ...
      methods: {
        ...
        setDefalut () {
          if (this.Info.type === 'sgbenificiary') {
            this.positionValue = this.changChengBaseInfo.sgbenificiary[this.client.num].occupationName === '' ? '请选择职业名称' : this.changChengBaseInfo.sgbenificiary[this.client.num].occupationName
          } else {
            this.positionValue = this.changChengBaseInfo.scbenificiary[this.client.num].occupationName === '' ? '请选择职业名称' : this.changChengBaseInfo.scbenificiary[this.client.num].occupationName
          }
        },
        choseAdd: function() {
          this.showChose = true;
