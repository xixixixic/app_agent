<template>
    <div class="detail">
        <div class="info">
            <p class="desTitle" ref='nameTitle'>受益人开户银行</p>
...
export default {
    ...
    created () {
     ...
     methods: {
        setDefault () {
            this.selected = this.Info.defaultBenifitInsBankName
        },
        showSelectdrop () {
		...
		sureSelectDrop (data) {
            ...
            console.log(data.nativeCode)
            console.log('银行卡data.nativeCode')
