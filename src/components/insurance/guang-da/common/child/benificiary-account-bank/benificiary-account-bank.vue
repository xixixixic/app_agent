<template>
    <div class="detail">
        <div class="info">
            <p class="desTitle" ref='nameTitle'>受益人授权开户银行</p>
            <p class="placeholders">
                <input type="text" placeholder="请填写受益人授权开户银行" class="placeholdersInput" v-model="values" @blur='verValues'/>
            </p>
        </div>
...
export default {
    ...
    methods: {
        setDefalut () {
            this.values = this.Info.defaultBenificiaryAccountBank
        },
        verValues () {
