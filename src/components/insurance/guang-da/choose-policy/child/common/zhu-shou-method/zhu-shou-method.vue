<template>
    <div class="detail">
        <div class="mainInfoLi"><span class="spanLeft">祝寿金领取方式</span><span class="spanRight" @click="showSelectdrop()">{{text}}<i class="icon-down_arrow ico"></i></span></div>
...
export default {
    ...
    computed: {
        ZhuShouMoneyArray () {
            return this.guangdaPolicy.getZsList
        },
        text () {
    ...
    created () {
     ...
     methods: {
        setDefault () {
             this.selected = this.guangdaPolicy.GetZsType
        },
        showSelectdrop () {
