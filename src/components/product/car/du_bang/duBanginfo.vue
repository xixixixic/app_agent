<template>
	<div class="info">
		<div class="main-info">
			<div class="img-box">
				<img class="imgBig" src='./dubangBig.png'/>
			</div>
			<div class="information">
				<div class="box">
					<div class="name">都邦机动车辆保险</div>
					<div class="logo"><img src='./dubang.jpg' class="img" /></div>
				</div>
			</div>
			<div class="service">
...
<script>
	...
	import InsuranceInfo from 'components/product/car/du_bang/children/insurance_info/insurance_info'
	import ducase from 'components/product/car/du_bang/children/case/case'
	import ClaimsGuide from 'components/product/car/du_bang/children/claims_guide/claims_guide'
